...
const pageName = "Liquidata org billing page";
const orgName = "Liquidata";
const currentPage = `/organizations/${orgName}/billing`;
...
describe(`${pageName} renders expected components on different devices`, () => {
  ...
  const testTabContainer = [
    ...
    newExpectation(
      "should show no billing permissions message",
      "[data-cy=not-billing-owner-msg]",
      beVisible,
    ),
    newExpectation(
